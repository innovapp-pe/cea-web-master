...
?>
    ...
    <body class="animated fadeIn">
        ...
        <div class="container col-md-8">
            <br>
            <h2 class="animated fadeInDown" style="text-align: center;">
            <span><i class="fas fa-chalkboard-teacher"></i></span>
            Bienvenido, <b><?php echo htmlspecialchars($_SESSION['name']); ?></b></h2>
            <h2 class="animated fadeInDown" style="text-align: center;">
            ¿Qué desea hacer?</h2>
            <br><br>
            <div class="container-fluid">
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4" style="padding-top: 10px; padding-bottom: 10px;">
                <div class="skew four col" onclick="location.href='addCourse.php';">
                    <div class="box">
                        <span class="original">
                            <br><br>
                          <h1>Crear Curso</h1>
                          <p>Cursos para este mes: ? </p>
                        </span>
                        <div class="overlay">
                            <i class="fas fa-list-alt fa-3x" aria-hidden="true"></i>
                            <span style="font-size: 1.5em;">&nbsp;Crear ahora</span>
                        </div>
                    </div>
                </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4" style="padding-top: 10px; padding-bottom: 10px;">
                <div class="skew four col" onclick="location.href='addEnrollment.php';">
                    <div class="box">
                        <span class="original">
                            <br><br>
                          <h1>Matrícula</h1>
                          <p>Matriculados actuales: ?</p>
                        </span>
                        <div class="overlay">
                            <i class="fas fa-user-plus fa-3x" aria-hidden="true"></i>
                            <span style="font-size: 1.5em;">&nbsp;Matricular ahora</span>
                        </div>
                    </div>
                </div>
                </div>
