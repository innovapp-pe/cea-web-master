...
?>
    ...
    <body class="animated fadeIn">
        ...
        <div class="container col-md-8">
            ...
            Creación de Nuevo Curso</h3>
            <br>
            <br>
            <form id="form" method="post" action="server/addCourseServer.php">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <input type="hidden" id="gestionado" name="gestionado" value="1">
                    <div class="form-group">
                        <label for="id_curso">ID del curso:*</label>
                        <input oninput="this.value = this.value.toUpperCase()" type="text" class="form-control" name="id_curso" id="id_curso" required/>
                    </div>
                    <div class="form-group">
