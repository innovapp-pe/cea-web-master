	...
	<body class="animated fadeIn">
		...
		<div id="hola" class="header animated fadeInDown">
			<div class="stoppable col-xs-12 col-sm-6 col-md-6 col-lg-6">
				<img src="../images/search.png" style="display: block; margin: 0 auto; width: 6em; margin-top: 0px;">
			</div>
			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
				<h3 style=""><b><?php echo htmlspecialchars($_SESSION['name']); ?></b>, este es el resultado de tu búsqueda: <?php echo htmlspecialchars( $_POST['dni_to_search']); ?>.</h3>
			</div>
		</div>
		</div>
		<br><br>
		...
		<button onclick="location.href='addEnrollment.php?dni=';" class="button1">Ir a Matrícula</button>
		<br><br>
