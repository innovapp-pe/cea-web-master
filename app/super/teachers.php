...
<html>
	...
	<body class="animated fadeIn">
		<nav class="navbar navbar-inverse">
		 ...
		 <div class="header animated fadeInDown"><h1><b>Profesores</b></h1></div>
				<div class="container">
					<div class="main">
					<table id="teachers-grid"  cellpadding="0" cellspacing="0" border="0" class="display" width="100%">
							<thead>
								<tr>
		...
		<script type="text/javascript" language="javascript" >
			$(document).ready(function() {
				var dataTable1 = $('#teachers-grid').DataTable( {
					"processing": true,
					"serverSide": true,
					"responsive": true,
					"bPaginate": true,
        			...
        			"bFilter": true,
					"ajax":{
						url :"ajax/teachersAjax.php", // json datasource
