	...
	<body class="animated fadeIn">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    ...
                    Agendados para Hoy</span></a>
                        ...
                        <li><a href="index.php"><span><i class="fas fa-user-plus"></i>
                </span>Nuevo Prospecto</a></li>
                        <li class="active"><a href="prospectos.php"><span><i class="fas fa-coins"></i></span> Mis Prospectos</a></li>
		...
		<div class="container">
		  <ul class="nav nav-tabs">
		    <li class="active"><a data-toggle="tab" href="#total">Gestión Total</a></li>
		    <li><a data-toggle="tab" href="#prospectos">Prospectos</a></li>
		  </ul>
		    ...
		    <div id="total" class="tab-pane fade in active">
		    	...
		    	<div class="container-fluid">
		    		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		    			...
		    			<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" style="padding: 30px 30px; text-align: center;">
		    				<h3> Mi Información:</h3>
		    				<h4>Prospectos Cuota: <span>200</span></h4>
		    				<h4>Prospectos Actuales: <span id="prospectos_actuales"></span></h4>
		    				<h4>Cargo Fijo: S/. <span id="cargo_fijo"></span></h4>
		    			</div>
		    		</div>
		    	</div>
		    </div>
		    <div id="prospectos" class="tab-pane fade">
		      <div class="header animated fadeInDown"><h1><b>Tus Prospectos</b></h1></div>
				<div class="container">
					<div class="main">
					<table id="prospectos-grid"  cellpadding="0" cellspacing="0" border="0" class="display" width="100%">
							<thead>
								<tr>
		...
		<script>
			...
			<script type="text/javascript">
				$(document).ready(function() {
	    			setTimeout(function() {
	        		var rowCount_prospectos = $('#prospectos-grid >tbody >tr').length;
