...
?>
    ...
    <body class="animated fadeIn">
        ...
        <div class="container col-md-8">
            <br>
            <span class="animated fadeInDown"><img src="images/alert.png" style="display: block; margin: 0 auto; width: 6em;"></span>
            <h3 class="animated fadeInDown" style="text-align: center;">
            No se pudo guardar el prospecto <?php echo htmlspecialchars( $_GET['name']); ?>.</h3><br>
            <h4 class="animated fadeInDown" style="text-align: center;">Este DNI ya existe, o se perdió la conexión a Internet durante el registro.</h4>
            <br>
            <br>
