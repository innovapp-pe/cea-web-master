...
?>
    ...
    <body class="animated fadeIn">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    ...
                    Agendados para Hoy</span></a>
                        ...
                        <li class="active"><a href="index.php"><span><i class="fas fa-user-plus"></i>
        ...
        <div class="container col-md-8">
            ...
            <img src="images/plus.png" style="display: inline-block; width: 1em; margin-top: -5px;">
            Creación de nuevo prospecto</h3>
            <br>
            <br>
            <form id="form" method="post" action="addProspectServer.php">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <input type="hidden" id="gestionado" name="gestionado" value="1">
                    <div class="form-group">
                        <label for="name">Nombres:*</label>
                        <input oninput="this.value = this.value.toUpperCase()" type="name" class="form-control" name="name" id="name" required/>
                    </div>
                    <div class="form-group">
                        <label for="last_name">Apellidos:*</label>
                        <input oninput="this.value = this.value.toUpperCase()" type="name" class="form-control" name="last_name" id="last_name" required/>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                       ...
                       <ul class="nav nav-tabs">
                        <li class="active"><a data-toggle="tab" href="#cursos-economia">Economía</a></li>
                        <li><a data-toggle="tab" href="#cursos-contabilidad">Contabilidad</a></li>
                        <li><a data-toggle="tab" href="#cursos-gestion-publica">Gestión Pública</a></li>
                      </ul>
                      <div class="tab-content">
                        <div id="cursos-economia" class="tab-pane fade in active">
                          <h3>Cursos de Economía</h3>
                          <div id="genera-cursos-economia">
                              <?php 
                                    //Create the query
                                    $sql = "SELECT `nombre` FROM cursos_brochure WHERE `area` = 'ECONOMIA'";
                               ...
                               ?>
                                    ...
                                    <input type="checkbox" name="cursos_interes[]" value="<?php echo $row['nombre'];?>"/><?php echo $row['nombre']; ?>
                                    </label>
                                    </div>
                        ...
                        <div id="cursos-contabilidad" class="tab-pane fade in">
                          <h3>Cursos de Contabilidad</h3>
                          <div id="genera-cursos-economia">
                              <?php 
                                    //Create the query
                                    $sql = "SELECT `nombre` FROM cursos_brochure WHERE `area` = 'CONTABILIDAD'";
                        ...
                        <div id="cursos-gestion-publica" class="tab-pane fade in">
                          <h3>Cursos de Gestión Pública</h3>
                          <div id="genera-cursos-economia">
                              <?php 
                                    //Create the query
                                    $sql = "SELECT `nombre` FROM cursos_brochure WHERE `area` = 'GESTION PUBLICA'";
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="padding-bottom: 50px; padding-top: 50px;">
